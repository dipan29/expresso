               ...
               <form method="POST" name="contactform" action="post_content.php">                     
					...
					<div class="form-group ">
						...
						Select Your Content Type : <br>
 							...
 							<input type="radio" id = "typeID" name="type" value="Blog (Personal)" checked> Blog (Self)
                   ...
                   <div class="form-group ">
					...
					<div class="form-group ">
                        ...
                        <script>
						<!--CKEDITOR.plugins.addExternal( 'imagebrowser', '/ckeditor/plugins/imagebrowser/browser', 'browser.js' );-->
