  ...
  fjs.parentNode.insertBefore(js, fjs);
				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<h1 class="to-animate" >Social Connect : M-Science and Tech</h1> 
                    
                    <div class="fb-like" data-href="https://www.facebook.com/m.science.tech" data-layout="button_count" data-action="like" data-size="large" data-show-faces="true" data-share="true"></div>
	...
	<section id="fh5co-work" data-section="work">
    	...
    	<?php
					...
					$result = mysqli_query($con, "SELECT * FROM facebook WHERE view='P' and pid=4 ORDER BY id DESC ");
