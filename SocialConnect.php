				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<h1 class="to-animate" >Expresso : Social Connect</h1> 
                    
                    <div class="fb-like" data-href="https://www.facebook.com/mindwebs" data-layout="button_count" data-action="like" data-size="large" data-show-faces="true" data-share="true"></div>
                              <br> <br>          
                            <h2 class="to-animate">WELCOME <?php if (isset($_SESSION['usr_id'])) { echo $_SESSION['usr_name']; } ?></h2>
							<h2 class="to-animate"><?php if (isset($_SESSION['usr_id'])) { 
															if((($_SESSION['usr_type'])=='A') ||	(($_SESSION['usr_type'])=='W')) { ?>
																<a href="upload_SC.php">Create Links Now</a>
														<?php		}
															 } ?></h2>
						</div>
					</div>
...
<div class="col-md-4 col-sm-6 col-xxs-12">
	<a href="SocialConnect_mindwebs.php" class="fh5co-project-item to-animate">
		<img src="facebook/img/1.jpg" alt="Image" class="img-responsive">
...
<div class="col-md-4 col-sm-6 col-xxs-12">
	<a href="SocialConnect_diaryofminds.php" class="fh5co-project-item to-animate">
		<img src="facebook/img/2.jpg" alt="Image" class="img-responsive">
		<div class="fh5co-text">
			<h2>M-Diary</h2>
			<span></span>
		</div>
...
<div class="col-md-4 col-sm-6 col-xxs-12">
	<a href="SocialConnect_sports_updates_now.php" class="fh5co-project-item to-animate">
		<img src="facebook/img/3.jpg" alt="Image" class="img-responsive">
		<div class="fh5co-text">
...
<div class="col-md-4 col-sm-6 col-xxs-12">
	<a href="SocialConnect_m_sci_tech.php" class="fh5co-project-item to-animate">
		<img src="facebook/img/4.jpg" alt="Image" class="img-responsive">
		<div class="fh5co-text">
			<h2>M - Science and Tech</h2>
			<span></span>
		</div>
	</a>
</div>		
