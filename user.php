...
/*	$resultB = mysqli_query($con, "SELECT * FROM post_blog WHERE id = '" .$id. "' ");
	...
	$resultA = mysqli_query($con, "SELECT * FROM users WHERE username= '" .$username. "' ");
...
/*	$resultB = mysqli_query($con, "SELECT * FROM post_blog WHERE id = '" .$id. "' ");
	...
	$resultA = mysqli_query($con, "SELECT * FROM users WHERE id= '" .$id. "' ");
		if ($resultA->num_rows > 0) {
			while($rowA = $resultA->fetch_assoc()) { 
...
<script type='text/javascript' src='//platform-api.sharethis.com/js/sharethis.js#property=59f386acd8dd210012a0a82d&product=sticky-share-buttons' async='async'></script>	
	...
	<meta property="og:url" content="http://expresso.mindwebs.org/user.php?var=<?php echo $id; ?>"/>
	<meta property="og:site_name" content="Expresso"/>
	<meta property="og:description" content="View the profile of <?php echo $author; ?>. Check all submissions of the <?php echo $author; ?> here."/>
			...
			<div class="container">
		        ...
		        <div id="navbar" class="navbar-collapse collapse">
		          <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="home.php" class="external"><span>The Blog</span></a></li>
		            <?php if (isset($_SESSION['usr_id'])) { ?>
                    	<?php if(($_SESSION['usr_email']) == $email) { ?>
						<li ><a href="update.php" class="external" ><span>Update User Profile</span></a></li>
                        <?php } ?>
		            <?php } else {?>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate"><?php echo $author; ?></h2>
					<div class="row">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="fh5co-person text-center to-animate">
						<figure><img style="height:auto" src="<?php echo "uploads/profile/" . $image ; ?>" alt="Image"></figure>
						<?php if(isset($username)) { ?><h3>@<?php echo $username; ?></h3>   <!--Check Here , Create New Query Up for Email --><?php } ?>
                        <br>
                    ...
                    <div class="col-md-8 col-md-offset-2 subtext to-animate">							                           
                            ...
                            <?php if (isset($_SESSION['usr_id'])) { ?> 
                            <center><h4 class="to-animate"><a href="submit_user.php" target="_blank">Want To POST Something. Please Do it Here</a></h4></center>
                            <?php } ?>
                            
                            <?php if(	isset($_SESSION['usr_id'])	&& ($_SESSION['usr_id'])== $id) { ?>
				<center><h3><a href="update.php" >Click Here to Update Your Profile </a></h3></center>
			    <?php } ?>
						</div>
	...
	<section id="fh5co-work" data-section="work">
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					...
					<div class="row">
						...
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
                            <?php if (isset($author)) { ?> 
                            <!--<h3>Submissions By- <?php echo $author; ?> </h3>-->
                            <?php } ?> 
			...
			<div class="row row-bottom-padded-sm">
    			<?php
                    ...
                    <div class="col-md-4 col-sm-6 col-xxs-12">	  
                    		<a class="fh5co-project-item to-animate">   <!-- Check This Part Link -->
				...
				echo "The User has not yet made his/her first post";
				}
			?>
			...
			<div class="row">
            	    ...
            	    <?php 
					$resultC = mysqli_query($con, "SELECT * FROM upload_img WHERE published = 'Y' and email= '".$email."'  ");
