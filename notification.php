			...
			<div class="container">
		        ...
		        <div id="navbar" class="navbar-collapse collapse">
		          <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#" class="active" data-nav-section="work"><span>Notifications</span></a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate">Notifications</h2>
					<div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
							<p><a href="seenNotify.php">Click HERE to MARK ALL AS SEEN </a></p>                           
						</div>
					</div>
				</div>
			</div>
			<div class="row row-bottom-padded-sm">
    			<?php
					...
					$result = mysqli_query($con, "SELECT * FROM user_notify WHERE email = '".$_SESSION['usr_email']."' AND seen = 'N' ");
					if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) { 
					$id = $row['id']; ?>
		
							<div class="col-md-4 col-sm-6 col-xxs-12">	  
                    		<a href="<?php echo "seenNotify.php?var=" . $row["id"] ; ?>" class="fh5co-project-item to-animate">   <!-- Check This Part Link -->
								...
								?></span>
                                <br><span style="color:blue">Click To Mark As Seen </span>
