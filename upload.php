		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate">Upload</h2>
                    
					<div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
							<h2 class="to-animate">WELCOME <?php if (isset($_SESSION['usr_id'])) { echo $_SESSION['usr_name']; } ?>, Submit Any Content Now</h2>
			...
			<div class="row row-bottom-padded-md">
               ...
               <form method="POST" name="uploadform_1" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">                     
					...
					<div class="form-group ">
						<label for="imagename" class="sr-only">Image Name</label>
						<input id="name" name ="name" class="form-control" placeholder="Image Name (format : img_[date][no] )"  type="text">
					</div>
                    <div class="form-group ">
               ...
               <form method="POST" name="deleteform" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
                ...
                <div class="form-group ">
						<input class="btn btn-primary btn-lg" name = "delete" value="Delete Image" type="submit">
					</div>
