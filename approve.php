		...
		$successmsg = "Approval Done!!! Please Close the Page";
			...
			if ($resultA->num_rows > 0) {
				while($rowA = $resultA->fetch_assoc()) { 
					...
					$contentAct = $_SESSION['usr_name']." Approved Content of : ".$to ." At : ". $timeNow;
...
if (isset($_POST['img_delete'])) {
	...
	if(mysqli_query($con, "UPDATE upload_img SET published = 'D' WHERE id = '" .$id. "' AND Published = 'Y' ")) {
		...
		$contentAct = $_SESSION['usr_name']." Deleted Content with ID= ".$id ." At : ". $timeNow;
					$resultAct = mysqli_query($con,"INSERT INTO activity(type,email,content,time) VALUES('Approval', '".$_SESSION['usr_email']."', '".$contentAct."', '".$timeNow."') ");
	} else {
			...
			<div class="container">
		        ...
		        <div id="navbar" class="navbar-collapse collapse">
		          <ul class="nav navbar-nav navbar-right">
		            ...
		            <?php } ?>
                    <li><a href="admin.php" class = "external" data-nav-section="home"><span>Admin Panel</span></a></li>
...
<a name="display"></a>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate">Administrator Approval</h2>
                			<?php if (isset($_SESSION['usr_id'])) { ?> 
						...
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
							<h3>Unapproved Submissions LIST</h3>
						</div>
 ...
 <div class="row">
		<div class="col-md-12 text-center to-animate">
				USER UPLOADED IMAGE	PENDING   <br>
		</div>
</div>            
            <?php
					...
					echo "\nNo submission is pending approval\n";
				}
		?>    
 <div class="row">
		<div class="col-md-12 text-center to-animate">
				THE BLOG PENDING UPLOADS	<br>
		</div>
</div>
