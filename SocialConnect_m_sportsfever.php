  ...
  fjs.parentNode.insertBefore(js, fjs);
				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<h1 class="to-animate" >Social Connect : Sports Fever</h1> 
	...
	<section id="fh5co-work" data-section="work">
    	...
    	<?php
					...
					$result = mysqli_query($con, "SELECT * FROM facebook WHERE view='P' and pid=5 ORDER BY id DESC ");
					if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) { ?>
                    <div class="col-md-4 col-sm-6 col-xxs-12">	
						<a href="#" class="fh5co-project-item image-popup to-animate">
                    		<iframe src="https://www.facebook.com/plugins/post.php?<?php echo $row["url"] ;?>width=350" width="350" height="420" style="border:none;overflow:scroll" scrolling="yes" frameborder="0" allowTransparency="true"></iframe>
