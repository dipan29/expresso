...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<header role="banner" id="fh5co-header">
			<div class="container">
			    ...
			    <?php if (isset($_SESSION['usr_id'])) { 
		            ...
		            <li><a href="#" class="active" data-nav-section="home"><span>Submit</span></a></li>
	...
	<section id="fh5co-work" data-section="work">
		<h1 class="to-animate text-center" style="color:white">WELCOME <?php if (isset($_SESSION['usr_id'])) { echo $_SESSION['usr_name']; } ?></h2>
	</section>
