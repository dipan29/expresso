...
if(isset($_SESSION['usr_id'])!="") {
	header("Location: submit_link.php");
	$user = true;
} else {
	$user = false;
}
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<header role="banner" id="fh5co-header">
			<div class="container">
			    ...
			    <?php if (isset($_SESSION['usr_id'])) { 
		            ...
		            <li><a href="submit.php" class="active" data-nav-section="home"><span>Submit Content</span></a></li>
	...
	<section id="fh5co-work" data-section="home">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate">Submit Your Content</h2>
                    <div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
							<h3>Fill Up the Form to submit to us</h3>
                            <h4>Further Communications will be done through Email </h4>
						</div>
					</div>
				</div>
			</div>
			<div class="row row-bottom-padded-md">
				...
				<div class="col-md-6 to-animate">
					<h3>Fill out the form below to send us your content!</h3>
                    
               <form method="POST" name="contactform" action="post.php">                     
					...
					<div class="form-group ">
						<input class="btn btn-primary btn-lg" name = "contact" value="Send Message" type="submit">
					</div>
					</div>
