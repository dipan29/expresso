	...
	$resultA = mysqli_query($con, "SELECT * FROM post_blog WHERE id = '" .$id. "' ");
		if ($resultA->num_rows > 0) {
			while($rowA = $resultA->fetch_assoc()) { 
					$post_name = $rowA["subject"]. " : " . $rowA["name"];
					$post_author = $rowA["email"];
					$post_nauthor = $rowA["name"];
					$post_content = $rowA["content"];
			}
		}
...
<script type='text/javascript' src='//platform-api.sharethis.com/js/sharethis.js#property=59f386acd8dd210012a0a82d&product=sticky-share-buttons' async='async'></script>	
	...
	<title><?php echo $post_name; ?> &mdash; Expresso</title>
	...
	<meta property="og:title" content="<?php echo $post_name; ?> &mdash; Expresso"/>
	<meta property="og:image" content="http://expresso.mindwebs.org/favicon.png"/>
	<meta property="og:image:type" content="image/png" /> 
	<meta property="og:url" content="http://expresso.mindwebs.org/post-<?php echo $id; ?>.blog"/>
	<meta property="og:site_name" content="Expresso"/>
	<meta property="og:description" content= "Click Here to view the whole post. Expresso, The self designed blog for everyone by Dipan Roy. Register Now to get your blogging panel and start sharing :) ." />
	<meta name="twitter:title" content="<?php echo $post_name; ?> &mdash; Expresso" />
	<meta name="twitter:image" content="http://expresso.mindwebs.org/favicon.png" />
	<meta name="twitter:url" content="" />
	<meta name="twitter:card" content="<?php echo $post_name; ?>. Click Here to view the whole post. Expresso, The self designed blog for everyone by Dipan Roy. "/>
...
<a name="display"></a>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate">Submission</h2>
					<div class="row">

						<div class="col-md-8 col-md-offset-2 subtext to-animate">                           
                            <?php if (isset($_SESSION['usr_id'])) { ?> 
                            <h3 class="to-animate"><a href="submit_user.php" target="_blank">Want To POST Something. Please Do it Here</a></h3>
                            <?php } ?>
    			...
    			<?php
                    ...
                    <div class="col-md-6 col-sm-6 col-xxs-12">	  
                            ...
                            <div class="fh5co-text">
								...
								<?php if(($row["type"] == "Quote") || ($row["type"] == "Poem")) {  ?> <div class="text-center"><?php } ?>
                                	<span><?php echo nl2br($row["content"]) ; ?></span><br><br>
                                <?php if(($row["type"] == "Quote") || ($row["type"] == "Poem")) {  ?> </div> <?php } ?>
	...
	<section id="fh5co-about" data-section="about">
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate">About The Author : <?php echo $post_nauthor; ?></h2>
					<div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
							
                            <h3>Check Our Entire Team <a href="team.php#show" target="_blank">Here</a></h3>
                            <h3><a href="<?php echo "view_user.php?var=" . $id ; ?>" class="fh5co-project-item to-animate">View User Profile</a></h3>
						</div>
					</div>
				</div>
			</div>
