				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<h1 class="to-animate">MinD Webs - Inspiring The Inspirers</h1>                            
                            <h2 class="to-animate">Thank You <?php if (isset($_SESSION['usr_id'])) { echo $_SESSION['usr_name']; } ?> For Your Submission</h2>
