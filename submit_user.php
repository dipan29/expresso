...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<header role="banner" id="fh5co-header">
			<div class="container">
			    ...
			    <?php if (isset($_SESSION['usr_id'])) { 
		            ...
		            <li><a href="#" class="active" data-nav-section="work"><span>Submit Content</span></a></li>
                    <li><a href="upload_photo.php" class="external"><span>Submit Image</span></a></li>
	...
	<section id="fh5co-work" data-section="work">
		<h1 class="to-animate text-center">WELCOME <?php if (isset($_SESSION['usr_id'])) { echo $_SESSION['usr_name']; } ?>, Post Your Content Now</h2>
	</section>
	...
	<section id="fh5co-contact" data-section="contact">
		<div class="container">
			...
			<div class="row row-bottom-padded-md">
               ...
               <form method="POST" name="contactform" action="post_content.php">                     
					<div class="form-group ">
						<!--<label for="name" class="sr-only">Name</label>-->Name To Be Displayed
					...
					<div class="form-group ">
						<!--<label for="email" class="sr-only">Email</label>-->Your Email Address (Not Editable by default)
						<input id="email" name ="email" class="form-control" placeholder="Email" value="<?php if (isset($_SESSION['usr_id'])) { echo $_SESSION['usr_email']; } ?>" type="email" disabled required>
					</div>
					<div class="form-group ">
						<label for="type" class="sr-only">Type</label>
						Select Your Content Type : <br>
							<input type="radio" id = "typeID" name="type" value="Quote" checked> Quote
 							<input type="radio" id = "typeID" name="type" value="Poem"> Poem 
 							<input type="radio" id = "typeID" name="type" value="Story"> Story  
                            <input type="radio" id = "typeID" name="type" value="Not Specified"> Non-Specific <br>
							<input type="radio" id = "typeID" name="type" value="Blog (Sci-Tech)"> Blog (Sci-Tech)
 							<!--<input type="radio" id = "typeID" name="type" value="Blog (Personal)"> Blog (Self)-->
 							<input type="radio" id = "typeID" name="type" value="Thought"> Thought                             				
                    </div>
                    <div class="form-group ">
                   ...
                   <div class="form-group ">
					...
					<div class="form-group ">
						...
						<textarea name="content" id="message" cols="50" rows="10" class="form-control" placeholder="Your Content...Please Use appropriate punctuation and try to avoid spelling or grammatical errors" required></textarea>
                        
                        
					</div>
					<div class="form-group ">
						<input class="btn btn-primary btn-lg" name = "contact" value="Submit" type="submit">
					</div>
                </form> 
                </div>
            </div>
            ...
            <div class="row row-bottom-padded-md">
            	<div class="col-md-12 text-center">
                    ...
                    <div class="col-md-6 text-center">
                    <a href="upload_photo.php"><input class="btn btn-warning btn-lg" value="Image Upload"></a>
                   	</div>
            	</div>
            </div>
