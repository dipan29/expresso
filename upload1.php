...
if (isset($_POST['upload_image'])) {
	...
	$target2 = "../expresso/uploads/cb/".basename($_FILES['image']['name']);
	$target = "../expresso/uploads/cb/".$newfilename;
	
	
	
		if(move_uploaded_file($_FILES['image']['tmp_name'], "../expresso/uploads/cb/" . $newfilename)) {
