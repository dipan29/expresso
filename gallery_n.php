...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
			...
			<div class="container">
		        ...
		        <div id="navbar" class="navbar-collapse collapse">
		          <ul class="nav navbar-nav navbar-right">
		            ...
		            <?php } ?>
                    <li><a href="#" class = "active" data-nav-section="home"><span>Images Panel</span></a></li>
				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
                            ...
                            <h1 class="to-animate" style="font-size:32px !important">Images Panel</h1>                           
                            <h2 class="to-animate" >WELCOME <?php if (isset($_SESSION['usr_id'])) { echo $_SESSION['usr_name']; } ?></h2>
			<h2 class="to-animate" style="font-size:22px !important"><?php if (isset($_SESSION['usr_id'])=="") { echo "Please Login or Register to View All Posts"; } ?></h2>			
						</div>
					</div>
				</div>
			</div>
	...
	<section id="fh5co-work" data-section="work">
        ...
        <?php
					...
					$resultC = mysqli_query($con, "SELECT * FROM upload_img WHERE published='Y' ORDER BY id DESC ");
 ...
 <div class="row">
    	...
    	<?php
					...
					$result = mysqli_query($con, "SELECT * FROM image WHERE view='P' ORDER BY id DESC ");
					if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) { ?>
                    <div class="col-md-4 col-sm-6 col-xxs-12">	  
                    		<a href="<?php echo "uploads/" . $row["image"] ; ?>" class="fh5co-project-item image-popup to-animate">
							<img src="<?php echo "uploads/" . $row["image"] ; ?>" alt="Image" class="img-responsive">
        ...
        <?php if(isset($_SESSION['usr_id'])!="") {
					...
					$result = mysqli_query($con, "SELECT * FROM image WHERE view='R' ORDER BY id DESC ");
					if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) { ?>
                    <div class="col-md-4 col-sm-6 col-xxs-12">	  
                    		<a href="<?php echo "uploads/" . $row["image"] ; ?>" class="fh5co-project-item image-popup to-animate">
