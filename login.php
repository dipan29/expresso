		...
		<div class="container">
			...
			<div class="row row-bottom-padded-md">
                ...
                <form role="form" action="login_script.php" method="post" name="loginform">
					...
					<div class="form-group ">
                        ...
                        <input type="checkbox" name="remember" id="remember">Remember Me (Validity : 180 Days)
					</div>
					<div class="form-group ">
            ...
            <a name="registernow"></a>
				<div class="col-md-6 to-animate">
                    ...
                    <h4><a href="#registernow"><span>and Start Posting your writeups and pictures at Expresso now</span></a></h4>
					</div>
