...
if(isset($_SESSION['usr_id'])!="") {
	...
	if(!isset($_COOKIE["mobile"])) {
		setcookie ("mobile",$key,time()+ 6*30*24*60*60, '/');
	}
}
			...
			<div class="container">
		        ...
		        <div id="navbar" class="navbar-collapse collapse">
		          <ul class="nav navbar-nav navbar-right">
		            ...
		            <li class="active"><a href="#" data-nav-section="home"><span>LOGIN</span></a></li>
		            <li><a href="#registernow" data-nav-section="contact"><span>Register</span></a></li>
		...
		<div class="container">
			...
			<div class="row row-bottom-padded-md">
				...
				<div class="col-md-6 to-animate" >
                    ...
                    <h4><a href="#registernow"><span>Not Registered Yet? Register Here</span></a></h4>
					</div>
                <form role="form" action="login_scriptM.php" method="post" name="loginform">
					...
					<div class="form-group ">
						<label for="password" class="sr-only">Remember Me</label>				
                        <input type="checkbox" name="remember" id="remember">Remember Me (Validity : 14 Days)
					</div>
					<div class="form-group ">
                    ...
                    <p>If You have registered at : <a href="http://web.mindwebs.org">web.mindwebs.org</a>, You can use the same credentials here and vice-versa </p>
                 </form>
					</div>
            <a name="registernow"></a>
                ...
                <form role="form" action="register.php" method="post" name="signupform">
                    ...
                    <div class="form-group ">
						<label for="interest" class="sr-only">Gender</label>
						Select Your Area of Interest<br>
							<input type="radio" name="interest" value="Blogging">Blogging / Video Blogs
 							<input type="radio" name="interest" value="Web/Graphics"> Web or Grapic Designing <br>
 							<input type="radio" name="interest" value="Photography"> Photography or Videography  
                            <input type="radio" name="interest" value="Content Provider"> Content Provider <br>
                            <input type="radio" name="interest" value="Marketing and Management"> Marketing and Management 
                            <input type="radio" name="interest" value="Regular User" checked> Regular User or Subscriber 
           			</div> 
